...
(1, 'Acid', 20, 'LTR'),
(2, 'Acid Slurry', 180, 'KG'),
(3, 'Acid Thickener', 400, 'KG'),
(4, 'Alphox 200', 240, 'LTR'),
(5, 'AOS (Alpha Olefin Sulphonate)', 250, 'KG'),
(6, 'Balm Pack', 880, 'NOS'),
(7, 'BKC (Benzalkonium Chloride)', 150, 'LTR'),
(8, 'Caustic Soda', 80, 'KG'),
(9, 'Citric Acid', 150, 'KG'),
(10, 'Color', 400, 'LTR'),
(11, 'Crystals', 80, 'KG'),
(12, 'Glycerin', 200, 'LTR'),
(13, 'Handwash Base - Pearl', 200, 'KG'),
(14, 'Jasmine Perfume', 1000, 'LTR'),
(15, 'Perfume', 1000, 'LTR'),
(16, 'Phenyl Concentrate', 180, 'LTR'),
(17, 'RO Water', 0.5, 'LTR'),
(18, 'Robin Blue', 400, 'KG'),
